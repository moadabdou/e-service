...
$assignedModules = $moduleModel->getApprovedModulesByVac($professorId);
$info = null;
$deadline = null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['session_type'])) {
    ...
    if (!$selectedModuleId) {
        ...
        if (in_array($fileType, $allowedTypes)) {
            ...
            $saveResult = $noteModel->saveUploadedNoteVac($selectedModuleId, $professorId, $sessionType, $fileId);
