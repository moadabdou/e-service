...
INSERT INTO `module` VALUES (1,'Fran├ºais','Module de fran├ºais avanc├⌐','s1',3,1,'M1.1',10,5,0,0,1),(2,'Anglais','Module d\'anglais avanc├⌐','s1',3,1,'M1.2',8,6,0,0,1),(3,'Math├⌐matiques','Analyse math├⌐matique','s2',4,1,'M3.1',20,10,0,0,2),(20,'Algorithmique','Introduction ├á l\'algorithmique','s1',4,1,'M20',15,5,0,0,0),(21,'POO - Concepts','Concepts de la programmation orient├⌐e objet','s2',2,1,'M21.1',10,2,0,0,3),(22,'POO - Pratique Java','Travaux pratiques en Java','s2',2,1,'M21.2',5,5,0,0,3),(23,'Syst├¿mes d\'exploitation','Architecture et fonctionnement des OS','s3',5,1,'M23',20,10,0,0,0),(24,'HTML/CSS','Introduction au d├⌐veloppement web','s4',2,1,'M24.1',6,2,0,0,4),(25,'JavaScript','Langage JavaScript et DOM','s4',2,1,'M24.2',6,2,0,0,4),(26,'PHP','Introduction au langage PHP','s4',2,2,'M26',6,2,0,0,0);
